...
moves([_,_,_, AlphaBetaDepth,_,_], _):-   /*Pos = [CoputerTanks,HumenTanks,CurrentPlayer,AlphaBetaDepth,ComputerTankToMove,HumenTankToShoot]*/
...
tanks_life_sum([[_,_,Life,_,_]|Tanks],Sum):-
