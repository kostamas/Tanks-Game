...
moves(CX-CY, HX-HY, VISTED, MOVES, DEPTH):-   /* C-computer & H-humen
    DEPTH1 is DEPTH + 1,
    eight_neighbors(X-Y,[],MOVES1,DEPTH1),
    deep_moves(MOVES1,VISTED,MOVES,DEPTH1).


eight_neighbors(_,VISTED,VISTED,DEPTH):-
    DEPTH = 5,!.

eight_neighbors(X-Y,VISTED,MOVES,_):-       /* eight possible moves*/
...
deep_moves([X-Y|MOVES],VISITED,NewMoves,DEPTH):-
    ...
    moves(X-Y,VISITED1,MOVES1,DEPTH),
